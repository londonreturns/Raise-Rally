...
function Editbenefit() {
    ...
    const benefitid=editProductData.benefitIds;
    const benefit1Id=parseInt(benefitid[0]);
    const benefit2Id=parseInt(benefitid[1]);
    const benefit3Id=parseInt(benefitid[2]);
    console.log(benefit1Id);
    console.log(benefit2Id);
    console.log(benefit3Id);
    const { makePatchRequest, data } = usePatchAxios(`http://localhost:8080/api/products/${editProductData.productId}`);
                  ...
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      <li className="breadcrumb-item">
                        <a className="text-decoration-none">Edit Product</a>
                      </li>
                      <li
