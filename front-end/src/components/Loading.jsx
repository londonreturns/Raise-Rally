...
function Loading() {
  return (
    <>
    <div className="d-flex flex-column text-center loading">
      <div className="row container-fluid">
        <div className="col-lg-3">
          
        </div>
        <div className="col-lg-6">
        <svg className="bike d-flex " viewBox="0 0 48 30" width="48px" height="30px">
  <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1}>
    ...
    <polyline className="bike__front" points="32.5 2,38.5 19" strokeDasharray="19 19" />
        ...
        <div className="col-lg-12">
          <h3 className='fw-bold fs-4'>Loading...</h3>
        </div>
      </div>
