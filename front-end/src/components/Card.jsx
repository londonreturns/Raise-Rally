...
function Card({ imageSrc, title, description, companyName, price, daysLeft, progressPercentage, companyVerified, productVerified }) {
    ...
    <div className="col-lg-3 p-4">
      {/* <div className="d-flex justify-content-center pt-4"> */}
        <div className="card">
          <img
            src={imageSrc}
            className="card-img-top img-100"
            alt="..."
          />
          <div className="card-body">
            ...
            <div className="col">
              <div className="row mb-4">
                <p className="card-text preview-text">
                  {description}
                </p>
              </div>
